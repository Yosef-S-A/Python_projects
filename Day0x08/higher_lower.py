...
def play():
	...
	print ("Compare A: {}, {}, from {}.".format(data[comp_a]['name'], data[comp_a]['description'], data[comp_a]['country']))
	print (art.vs)
	print ("Compare B: {}, {}, from {}.".format(data[comp_b]['name'], data[comp_b]['description'], data[comp_b]['country']))
